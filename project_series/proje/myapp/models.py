...
class Product(models.Model):
    ...
    category=models.ForeignKey(Category, on_delete=models.CASCADE,null=True) # ilişki kurduk category ile burda , bir kategori silinirse ona bağlı ürünlerde silinsin istiyoruz on_delete=models.CASCADE ile , null=True bu alan boş geçilebilir demek..////Cascade yerine on_delete=models.SET_NULL da kullanılabilir bu durumda kategori silinirse ürün kalır ama kategorisi null olur null=true olması gerek ama dikkat bunu tanımlarsan, yada setdafult bi değer///
    ...
    slug =models.SlugField(default="", null=False,db_index=True, unique=True,blank=True,editable=False) #mig olucak bunun için name göre bi veri bulcaz /1 yerine products/telefonu bulcaz bunun sayesinde zaten otomatik oluşuyor sluga adminde görmemek için editable create aşamsında o kendi kendiine oluşcak zaten
